...
def insertTOdb(df,ch_nm,val):
    ...
    engine = create_engine("mysql+mysqldb://root:"+"1234"+"@3.35.70.166/proj?charset=utf8",encoding='utf8')
    conn = engine.connect()
...
# 검색 하기
######################################################################################################
querys = {'셀트리온':'068270','하이닉스':'000660','LG화학':'051910','현대차':'005380',"삼성전자":'005930'}
